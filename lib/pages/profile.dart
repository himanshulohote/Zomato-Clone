...
//                   mainAxisAlignment: MainAxisAlignment.center,
//                   children: [
//                   Text("Himanshu Lohote", style: TextStyle(
...
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: [
//                       Text("Name", style: TextStyle(color: Colors.black,fontSize: 16.0, fontWeight: FontWeight.w600
//                       ),
//                       ),
//                       Text("Himanshu Lohote", style: TextStyle(color: Colors.black,fontSize: 16.0, fontWeight: FontWeight.w600
//                       ),
//                       )
//                     ],)
//                   ],
...
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: [
//                         Text("Email", style: TextStyle(color: Colors.black,fontSize: 16.0, fontWeight: FontWeight.w600
//                         ),
//                         ),
//                         Text("himan465@gmail.com", style: TextStyle(color: Colors.black,fontSize: 16.0, fontWeight: FontWeight.w600
//                         ),
//                         )
//                       ],)
//                   ],
...
//                       children: [
//
//                         Text("Terms and Conditions", style: TextStyle(color: Colors.black,fontSize: 20.0, fontWeight: FontWeight.w600
//                         ),
//                         )
//                       ],)
//                   ],
...
//                       children: [
//
//                         Text("Delete Account", style: TextStyle(color: Colors.black,fontSize: 20.0, fontWeight: FontWeight.w600
//                         ),
//                         )
//                       ],)
//                   ],
